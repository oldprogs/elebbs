...
{$IFDEF FPC}
   {$IFDEF GO32V2}
      ...
      PidName        : String = 'EleBBS/386 v20090220';
      EleIrcName     = 'EleIRC/386 v20090220';
      VersionID      : String = '20090220';
      PlatformIDStr  = '386';
   {$ENDIF}
   ...
   {$IFDEF ELEUNIX}
      {$IFDEF FreeBSD}
        ...
        PidName        : String = 'EleBBS/FreeBSD v20090220';
        EleIrcName     = 'EleIRC/FreeBSD v20090220';
        VersionID      : String = '20090220';
      ...
      {$IFDEF LINUX}
       {$IFNDEF FreeBSD}
        ...
        PidName        : String = 'EleBBS/Linux v20090220';
        EleIrcName     = 'EleIRC/Linux v20090220';
        VersionID      : String = '20090220';
        PlatformIDStr  = 'Linux';
       {$ENDIF}
      {$ENDIF}
...
{$IFDEF OS2}
      ...
      PidName        : String = 'EleBBS/OS2 v20090220';
      EleIrcName     = 'EleIRC/OS2 v20090220';
      VersionID      : String = '20090220';
      PlatformIDStr  = 'OS2';
{$ENDIF}
...
{$IFDEF MSDOS}
 {$IFNDEF FPK}
      ...
      PidName        : String = 'EleBBS/DOS v20090220';
      EleIrcName     = 'EleIRC/DOS v20090220';
      VersionID      : String = '20090220';
      PlatformIDStr  = 'DOS';
 {$ENDIF}
{$ENDIF}
...
{$IFDEF WIN32}
  {$IFDEF WINGUI}
      ...
      PidName        : String = 'EleBBS/GUI v20090220';
      EleIrcName     = 'EleIRC/GUI v20090220';
      VersionID      : String = '20090220';                     { Current version }
      PlatformIDStr  = 'GUI';
  {$ELSE}
      FullProgName   = 'EleBBS/W32';
      EleIrcName     = 'EleIRC/W32 v20090220';
      PidName        : String = 'EleBBS/W32 v20090220';
      VersionID      : String = '20090220';                     { Current version }
      PlatformIDStr  = 'W32';
  {$ENDIF}
{$ENDIF}
